...
STUDY_NAMES = ['Skin_Not_Sun_Exposed_Suprapubic','Skin_Sun_Exposed_Lower_leg']
...
COVARIATES_DIR = "/project/mathilab/colbranl/pigmentation/data/gtex_v8/covariates/"
...
INTER_DIR = '/project/mathilab/colbranl/pigmentation/data/gtex_v8/'
OUTPUT_DIR = '/project/mathilab/colbranl/pigmentation/data/predixcan_models/gtex_v8_1240k/'
GENE_ANN_DIR = '/project/mathilab/colbranl/pigmentation/data/gtex_v8/'
SNP_ANN_DIR = '/project/mathilab/colbranl/pigmentation/data/snp_lists/'
SNP_ANN_INTER_DIR = '1240k_snps_hg38/'
GENOTYPE_INPUT_DIR = '/project/mathilab/colbranl/pigmentation/data/gtex_v8/raw_genotypes/'
EXPRESSION_INPUT_DIR = '/project/mathilab/colbranl/pigmentation/data/gtex_v8/raw_expression/residual/'
GENOTYPE_INTER_DIR = 'genotypes/'
EXPRESSION_INTER_DIR = 'expression/'
MODEL_BY_CHR_DIR = '/project/mathilab/model_by_chr/'
